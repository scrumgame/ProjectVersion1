...
},
{
  type: 'AC',
  id: 63,
  text: 'The costumer fires the new test manager. Testing effort is back to normal.',
  position: 0
},
{
  type: 'AC',
...
},
{
  type: 'AC',
  id: 70,
  text: 'Oh no! System is depending on finishing M5 at the end of this sprint. Unfortunately M5 is depending on M2, M3 and M4. Let us hope that the team has been working with them during previous sprints. If not - pull all remaining meintenance tasks into the sprint. If M5 is not finished by the end of the sprint the fine is 800$',
  position: 0
},
{
  type: 'AC',
...
},
{
  type: 'AC',
  id: 73,
  text: 'Roll the dice and put as many defects as the dice shows on top of the backlog. If the team has already completed some defects, pull in what is left. If all are completed, team recieves a bonus of 400$',
  position: 0
}]
