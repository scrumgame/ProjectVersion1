...
export default class Highscore extends Component {
  ...
  _renderTopTen() {
    return this.props.highscore.map((el, i) => <HighscoreRow key={i} teamname={el.teamname} total={el.total} />)
  }

  _renderCurrentTeam() {
    return <HighscoreRow key={1} teamname={this.props.highscorecurrentteam.teamname} total={this.props.highscorecurrentteam.total} />
  }
